...
export const HTTP: string = import.meta.env.VITE_API_URL ?? "http://localhost:8000/api/v1";

export const WS: string = import.meta.env.VITE_WS_URL ?? "ws://localhost:8000/api/v1/ws";
